...
function requestHeaders(superTest) {
  return _.omitBy(superTest._headers, function (value, key) {
...
function responseHeaders(superTest, response) {
  ...
  if (superTest._expectedHeaders) {
    var names = superTest._expectedHeaders.map(function (s) {
      return s.toLowerCase()
    });
    return _.pickBy(response.headers, function (value, key) {
